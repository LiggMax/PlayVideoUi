 ...
 * @returns {Promise} 响应结果
 */
export function getUserSubscriptions(userId, page = 1, size = 10) {
  return request({
    url: `/api/user/${userId}/subscriptions`,
    method: 'get',
    params: { page, size }
  })
}
 ...
 * @returns {Promise} 响应结果
 */
export function getUserSubscribers(userId, page = 1, size = 10) {
  return request({
    url: `/api/user/${userId}/subscribers`,
    method: 'get',
    params: { page, size }
  })
}
